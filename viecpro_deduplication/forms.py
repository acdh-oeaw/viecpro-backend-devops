...
class GroupForm(ModelForm):
    ...
    def __init__(self, inst_id, *args, **kwargs):
        ...
        self.helper.form_action = reverse("viecpro_deduplication:handle_note_form", kwargs={
                                          "g_id": inst_id, "type": "group"})
        self.helper.add_input(
            Submit("submit", "save", css_id=f"post_note_{inst_id}"))
        self.helper.add_input(Button(
            "cancel", "Cancel", css_class="btn-danger", onclick=f"abortNoteEdit({inst_id},'group')"))
...
class PersonProxyForm(ModelForm):
    ...
    def __init__(self, inst_id, *args, **kwargs):
        ...
        self.helper.help_text_inline = True
        self.helper.form_action = reverse("viecpro_deduplication:handle_note_form", kwargs={
                                          "g_id": inst_id, "type": "personproxy"})
        self.helper.add_input(
            Submit("submit", "save", css_id=f"post_note_{inst_id}"))
        self.helper.add_input(Button("cancel", "Cancel", css_class="btn-danger",
                              onclick=f"abortNoteEdit({inst_id},'personproxy')"))
