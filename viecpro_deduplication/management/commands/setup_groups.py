...
class Command(BaseCommand):
    ...
    def calculate_names(self):
        #stdout.write("Started: Calculate Names")
        ...
        #stdout.write("step 1 finished")
        
        def get_names(names_set, res_dic):
            #stdout.write("running get names")
        ...
        #stdout.write("step 2 finished, get names done")
        
        def get_per_dic(data):
            #stdout.write("running get_per_dic")
        ...
        n = get_per_dic(res_n)
        f = get_per_dic(res_f)
        #stdout.write("finished all calculations")
        ...
        #     file.write(data)
        #stdout.write("Finished: Calculate Names")
