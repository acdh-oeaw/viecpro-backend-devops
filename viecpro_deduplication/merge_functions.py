...
from viecpro_deduplication.models import PersonProxy, Group
import json
...
- in merge_views.py, in the remergegroupview, that can be called in the viecpro_deduplication frontend section. The template for the button is member_list.html, the callback function resides in tool_page.html
"""
...
def update_merging_collections():
    ...
    col_new, c = Collection.objects.get_or_create(
        name="Singles (All ACC+Leopold)")
