...
def parse_court_relations(i:Any, res)->List[Any]: #TODO: add type hints
    """
    parse for: 
...
def parse_court_labels(i:Any, res)->List[Any]: #TODO: add type hints
    """
    parse for: 
...
def main(offset:int=0) -> Dict[str, Any]: 
    c = C(name="viecpro_detail_reference", fields=reference_fields)
    schema = c.to_schema()
    ...
    for idx, instance in enumerate(data): 
        ...
        #TODO: add parsing body
        # res = c.to_empty_result_dict()
        # res = parse_reference_labels(instance, res)
        # res = parse_reference_relations(instance, res)
