...
ALLOWED_HOSTS = re.sub(
    ...
    os.environ.get(
        "ALLOWED_HOSTS",
        "localhost,127.0.0.1,viecpro.acdh-dev.oeaw.ac.at,viecpro-dev.acdh-dev.oeaw.ac.at,acdh-cluster.arz.oeaw.ac.at,viecpro-backend.acdh-cluster-2.arz.oeaw.ac.at,viecpro-backend.acdh-ch-dev.oeaw.ac.at",
    ),
).split(",")
...
APIS_IMPORT_PROJECT_IIIF_BASE_URL = (
    "https://iiif.acdh-dev.oeaw.ac.at/iiif/images/viecpro/"
)
...
def custom_group_filter(queryset, request):
    ...
    return get_list_filter_of_entity(queryset.model.__name__)(
        request.GET, queryset=queryset
    ).qs


GROUP_FILTER = custom_group_filter
GROUP_MERGE_FUNCTION = "merge"
